...
- Bot creation provisions a sandbox and can take a while on first image/VM startup. If the exec tool reports the command is still running, keep polling it until it exits; do not terminate and retry unless the user explicitly cancels.
