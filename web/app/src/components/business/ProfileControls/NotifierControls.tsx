    ...
    <>
      <div className="field span-2">
        ...
        <div className="notifier-route-preview">
          <div><strong>GET</strong> {messagesURL || "-"}</div>
          <div><strong>ACK</strong> {ackURL || "-"}</div>
        </div>
      </div>
...
export function NotifierControls({ agentID, draft, onPatch, setWebhookOrigin, t, webhookOrigin }: NotifierControlsProps) {
  ...
  const relayPasteURL = notifierThirdPartyRelayWebhookURL(draft.notifier_remote_url, draft.notifier_remote_subscription_id);
        ...
        {deliveryMode === "webhook"
          ? (
              <>
                ...
                <label className="field span-2">
                  <FieldLabelWithHelp summary={t("notifierWebhookPublicOriginSummary")} detail={t("notifierWebhookPublicOriginHelp")}>
                ...
                <label className="field span-2">
                  <FieldLabelWithHelp summary={t("notifierThirdPartyCSGWebhookURLSummary")} detail={t("notifierThirdPartyCSGWebhookURLHelp")}>
          ...
          ? (
              <>
                ...
                <label className="field">
                  ...
                  <input value={draft.notifier_remote_subscription_id || ""} readOnly disabled title={t("notifierSubscriptionIDHelp")} />
                </label>
                {relayPasteURL
                  ? (
                      <label className="field span-2">
                        <FieldLabelWithHelp summary={t("notifierThirdPartyWebhookPasteURLSummary")} detail={t("notifierThirdPartyWebhookPasteURLHelp")}>
