export const messages = {
  zh: {
    ...
    notifierPullEffectiveRoutesSummary: "由收件箱地址解析；下方覆盖项优先。",
    ...
    notifierThirdPartyCSGWebhookURLHelp: "保存前 URL 中的 <agent_id> 为占位符；保存后再复制为真实 ID。",
  ...
  en: {
    ...
    notifierPollIntervalPlaceholder: "e.g. 2s, 30s; a plain number means seconds",
