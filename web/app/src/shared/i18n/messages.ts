export const messages = {
  zh: {
    ...
    floatingChatSuggestionUnfinishedTasks: "按优先级列出我未完成的任务",
    floatingChatSuggestionTodaySummary: "总结一下我今天做了什么",
    floatingChatSuggestionNextPlan: "规划接下来该做什么",
  ...
  en: {
    ...
    floatingChatSuggestionUnfinishedTasks: "List my unfinished tasks by priority",
    floatingChatSuggestionTodaySummary: "Summarize what I did today",
    floatingChatSuggestionNextPlan: "Plan what I should do next",
