...
export function ComputerDetailPane({ t, agents, channels, directMessages, busyKey, onSelectAgent, onCreateAgent, onStartAgent }) {
  ...
  return (
    <section className="entity-pane computer-detail-pane">
      ...
      <div className="section-header-inline">
        ...
        <Button variant="primary" className="send-button compact" onClick={onCreateAgent}>{t("createAgent")}</Button>
      </div>
