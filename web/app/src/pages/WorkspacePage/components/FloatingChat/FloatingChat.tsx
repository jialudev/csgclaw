...
import { Bot, ClipboardList, Lightbulb, MessageCircle, Minus, PencilLine } from "lucide-react";
...
const FLOATING_CHAT_SUGGESTION_KEYS = [
  "floatingChatSuggestionUnfinishedTasks",
  "floatingChatSuggestionTodaySummary",
  "floatingChatSuggestionNextPlan",
] as const;

const FLOATING_CHAT_SUGGESTION_ICONS = {
  floatingChatSuggestionUnfinishedTasks: ClipboardList,
  floatingChatSuggestionTodaySummary: PencilLine,
  floatingChatSuggestionNextPlan: Lightbulb,
} satisfies Record<(typeof FLOATING_CHAT_SUGGESTION_KEYS)[number], LucideIcon>;
      ...
      >
        {chatProps?.conversation ? (
          <FloatingChatPanel
            chatProps={chatProps}
            emptyStateSlot={
              <FloatingChatPromptSuggestions agentName={accessibleTitle} t={t} onPickPrompt={handlePickPrompt} />
            }
...
type FloatingChatPromptSuggestionsProps = {
  agentName: string;
  t: TranslateFn;
  onPickPrompt: (text: string) => void;
};

function FloatingChatPromptSuggestions({ agentName, t, onPickPrompt }: FloatingChatPromptSuggestionsProps) {
  return (
    <div className={styles.prompts}>
      ...
      <div className={styles.promptList}>
        {FLOATING_CHAT_SUGGESTION_KEYS.map((key) => {
          const Icon = FLOATING_CHAT_SUGGESTION_ICONS[key];
          const text = t(key);
          return (
