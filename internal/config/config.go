...
const (
	...
	// Default bootstrap manager image when bootstrap.agent_runtime is openclaw (same tag family as docs/onboard examples).
	DefaultOpenClawManagerImage = "opencsg-registry.cn-beijing.cr.aliyuncs.com/opencsg_public/openclaw-csgclaw:20260331.20260428.1"
